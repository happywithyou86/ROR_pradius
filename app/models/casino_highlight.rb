...
class CasinoHighlight < ActiveRecord::Base
  has_and_belongs_to_many :cards

  belongs_to :user

  belongs_to :tournament_best, :foreign_key => :best_placement, :class_name => 'CasinoTournament'
  belongs_to :tournament_most_exp, :foreign_key => :most_exp_buy_in, :class_name => 'CasinoTournament'

  belongs_to :cash_largest, :foreign_key => :cash_largest_win, :class_name => 'CasinoCashGame'
  belongs_to :cash_worst, :foreign_key => :cash_worst_loss, :class_name => 'CasinoCashGame'
end
